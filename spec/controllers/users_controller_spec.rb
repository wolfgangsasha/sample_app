...
describe UsersController do
  ...
  describe "POST 'create'" do
    ...
    describe "success" do
      ...
      before (:each) do
        @attr = { :name => "New User", :email => "new_user@test.com", 
  ...
  describe "PUT 'update'" do
    ...
    describe "success" do
      ...
      before(:each) do
        @attr = { :email => "New.Name@test.com", :name => "New Name", 
		  :password => "bebebebe", :password_confirmation => "bebebebe"}
        put :update, :id => @user, :user => @attr
      end
  ...
  describe "DELETE 'destroy'" do
    ...
    describe "as an admin user" do
      before(:each) do
        admin = Factory(:user, :email => "admin@test.com", :admin => true)
        test_sign_in(admin)
      end
